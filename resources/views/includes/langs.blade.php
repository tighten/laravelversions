@if (Config::has('localized-routes.supported-locales'))
    <select name="forma" onchange="location = this.value;" class="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8 -mt-9 float-right lang bg-gray-200 border border-gray-200 text-black text-xs rounded">
