<header class="py-8 bg-gray-700">
    <div class="flex flex-col max-w-(--breakpoint-xl) px-4 mx-auto sm:items-center sm:justify-between sm:flex-row-reverse sm:px-6 lg:px-8">
    ...
    <div class="{{ Route::is('*.versions.index') ? 'max-w-(--breakpoint-xl) px-4 py-4 mx-auto text-base text-white sm:px-6 lg:px-8' : 'hidden' }}">
